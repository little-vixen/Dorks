...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musemenu.js", "jquery.watch.js", "require.js", "saving_report.css"], "outOfDate":[]};
</script>
  ...
  <link rel="stylesheet" type="text/css" href="css/saving_report.css?crc=165970972" id="pagesheet"/>
	  <style type="text/css">
  body,td,th {
   ...
   <div class="clearfix colelem" id="u24358"><!-- group -->
    <div class="grpelem" id="u24328"><!-- simple frame -->
		...
		<center><form method='post' action='saving_report.php'>
			...
			<br><br>
			<input style="font-size: 150%; background-color: #0000FF; color: #fff; width: 400;" name="send" type="submit" value="Search">
			</form></center>
