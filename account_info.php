...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musemenu.js", "jquery.watch.js", "require.js", "withdraw.css"], "outOfDate":[]};
</script>
  ...
  <link rel="stylesheet" type="text/css" href="css/withdraw.css?crc=231483555" id="pagesheet"/>
	 <style type="text/css">
  body,td,th {
  ...
  <div class="clearfix borderbox" id="page"><!-- column -->
   ...
   <div class="clearfix colelem" id="u23571"><!-- column -->
    <div class="colelem" id="u23681"><!-- simple frame -->
	   <!--Assets Table-->
	<center><table class="table" style="position:relative;right:100px;">
		<tr class="row-header">
    ...
    <div class="colelem" id="u23572"><!-- simple frame --></div>
   </div>
