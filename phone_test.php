     ...
     <div class="grpelem" id="u24328"><!-- simple frame -->
		...
		<form method="post" action="phone_test.php">
			<p>
				...
				<br><br>
				<input type="text" name="email" style="width: 375px; height: 40px;">
			</p>
			<br>
			<p>
				<label style="font-size: 150%;color: #0000FF;">Customer ID:</label>
				<br><br>
				<input type="text" name="cid" style="width: 375px; height: 40px;">
			</p>
			<br>
			<p>
			<input style="font-size: 100%; background-color: #0000FF; color:antiquewhite; width: 375px; height:40px;" type="submit" name="add" value="Add Email">
			</p>
		</form>
		<!--SEND EMAIL-->
		<br><br>
		<form method="post" action="phone_test.php">
			<p>
				...
				<br><br>
				<input type="text" name="subject" style="width: 375px; height: 40px;">
			</p>
			<br><br>
			<p>
				<label style="font-size: 150%;color: #0000FF;">Body:</label>
				<br><br><br>
				<textarea name="comments" cols="60" rows="10" style="width: 375px; height:375;"></textarea>
			</p>
			<br>
			<p>
			<input style="font-size: 100%; background-color: #0000FF; color:antiquewhite; width: 375px; height:40px;" type="submit" name="send" value="Send">
			</p>
			</form></center>
