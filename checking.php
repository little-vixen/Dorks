...
<?php
	...
	Lists all Checking accounts for the logged in user. Uses the session variable
	for customer id(cid).
	*/
	...
	try {
		/*
		Return all checking accounts by Customer ID
		Input:	- ':cid' :	Customer ID
		Output:	Checking Accounts
		*/
		...
		*/
		$sql2 = "Select * FROM ctransaction WHERE cid = :cid";
...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musemenu.js", "jquery.watch.js", "jquery.museresponsive.js", "require.js", "checking.css"], "outOfDate":[]};
</script>
   ...
   <div class="clearfix borderbox" id="page"><!-- column -->
    ...
    <div class="clearfix colelem" id="u23571"><!-- column -->
     <div class="clearfix colelem" id="u23681"><!-- group -->
      ...
      <div class="grpelem shared_content" id="u39552" data-content-guid="u39552_content"><!-- custom html -->
       
		   <!--CHECKING ACCOUNTS-->
	<table class="table" style="position:center;">
		<tr class="row-header">
			<td class="cell" colspan="1" style="text-align:left;text-align:left;">Checking ID</td>
			<td class="cell" colspan="1" style="text-align:left;text-align:left;">Balance</td>
			<td class="cell" colspan="1" style="text-align:left;text-align:left;">Minimum Allowed</td>
			<td class="cell" colspan="1" style="text-align:left;text-align:left;">API</td>
		</tr>
		<?php foreach ($rows as $row) { ?>
		<tr>
			<td class="cell-r"style:" bordercolor: black; display: block;"><?php echo $row['checkid']; ?></td>
			<td class="cell-r"style:" bordercolor: black; display: block;"><?php echo $row['bal']; ?></td>
			<?php $balTotal = $balTotal + $row['bal']; ?>
			<td class="cell-r"style:" bordercolor: black; display: block;"><?php echo $row['minBal']; ?></td>
			<td class="cell-r"style:" bordercolor: black; display: block;"><?php echo $row['api']; ?></td>
		</tr>
		<?php } ?>
	  </table></center>
...
<center><!--CHECKING TRANSACTIONS-->
	<table class="table" style="position:center;">
		...
		<tr class="row-header">
			...
			<td class="cell" colspan="1" style="text-align:left;">Transaction Date</td></space><space>
			<td class="cell" colspan="1" style="text-align:left;">Amount</td></space><space>
			<td class="cell" colspan="1" style="text-align:left;">Checking ID</td></space>
		</tr>
        <?php foreach ($rows2 as $row2) { ?>
		<tr>
			<td class="cell-r" style:" bordercolor: black; display: block;"><?php echo $row2['tid']; ?></td>
			<td class="cell-r"style:" bordercolor: black; display: block;"><?php echo $row2['transdate']; ?></td>
			<td class="cell-r"style:" bordercolor: black; display: block;"><?php echo $row2['amount']; ?></td>
			<td class="cell-r"style:" bordercolor: black; display: block;"><?php echo $row2['checkid']; ?></td>
		</tr>
		<?php } ?>
    </table></center>
  ...
  <div class="breakpoint" id="bp_1273" data-min-width="1273" data-max-width="1273"><!-- responsive breakpoint node -->
   <div class="clearfix borderbox temp_no_id" data-orig-id="page"><!-- column -->
    <div class="clearfix colelem temp_no_id" data-orig-id="pu23584"><!-- group -->
     ...
     <span class="grpelem placeholder" data-placeholder-for="u39598_content"><!-- placeholder node --></span>
    </div>
    <div class="clearfix colelem temp_no_id" data-orig-id="u23571"><!-- column -->
     <div class="clearfix colelem temp_no_id" data-orig-id="u23681"><!-- group -->
      <img class="grpelem temp_no_id temp_no_img_src" alt="Account Balance:" data-orig-src="images/u39551-52.png?crc=4216946563" data-image-width="138" data-orig-id="u39551-5" src="images/blank.gif?crc=4208392903"/><!-- rasterized frame -->
      <span class="grpelem placeholder" data-placeholder-for="u39552_content"><!-- placeholder node --></span>
     </div>
     <div class="clearfix colelem temp_no_id" data-orig-id="u23572"><!-- group -->
      <img class="grpelem temp_no_id temp_no_img_src" alt="Transaction History:" data-orig-src="images/u39595-42.png?crc=304798917" data-image-width="142" data-orig-id="u39595-4" src="images/blank.gif?crc=4208392903"/><!-- rasterized frame -->
     </div>
    </div>
  ...
  <div class="breakpoint" id="bp_1272" data-min-width="987" data-max-width="1272"><!-- responsive breakpoint node -->
   <div class="clearfix borderbox temp_no_id" data-orig-id="page"><!-- column -->
    ...
    <div class="clearfix colelem temp_no_id" data-orig-id="u23571"><!-- column -->
     <div class="clearfix colelem temp_no_id" data-orig-id="u23681"><!-- group -->
      <img class="grpelem temp_no_id temp_no_img_src" alt="Account Balance:" data-orig-src="images/u39551-53.png?crc=4216946563" data-image-width="137" data-orig-id="u39551-5" src="images/blank.gif?crc=4208392903"/><!-- rasterized frame -->
      <span class="grpelem placeholder" data-placeholder-for="u39552_content"><!-- placeholder node --></span>
     </div>
     <div class="clearfix colelem temp_no_id" data-orig-id="u23572"><!-- group -->
      <img class="grpelem temp_no_id temp_no_img_src" alt="Transaction History:" data-orig-src="images/u39595-43.png?crc=304798917" data-image-width="142" data-orig-id="u39595-4" src="images/blank.gif?crc=4208392903"/><!-- rasterized frame -->
     </div>
    </div>
  ...
  <div class="breakpoint" id="bp_986" data-min-width="986" data-max-width="986"><!-- responsive breakpoint node -->
   <div class="clearfix borderbox temp_no_id" data-orig-id="page"><!-- column -->
    ...
    <div class="clearfix colelem temp_no_id" data-orig-id="u23571"><!-- column -->
     <div class="clearfix colelem temp_no_id" data-orig-id="u23681"><!-- group -->
      <img class="grpelem temp_no_id temp_no_img_src" alt="Account Balance:" data-orig-src="images/u39551-54.png?crc=3764341022" data-image-width="106" data-orig-id="u39551-5" src="images/blank.gif?crc=4208392903"/><!-- rasterized frame -->
      <span class="grpelem placeholder" data-placeholder-for="u39552_content"><!-- placeholder node --></span>
     </div>
     <div class="clearfix colelem temp_no_id" data-orig-id="u23572"><!-- group -->
  ...
  <div class="breakpoint" id="bp_985" data-max-width="985"><!-- responsive breakpoint node -->
   <div class="clearfix borderbox temp_no_id" data-orig-id="page"><!-- column -->
    ...
    <div class="clearfix colelem temp_no_id" data-orig-id="u23571"><!-- column -->
     <div class="clearfix colelem temp_no_id" data-orig-id="u23681"><!-- group -->
      <img class="grpelem temp_no_id temp_no_img_src" alt="Account Balance:" data-orig-src="images/u39551-55.png?crc=3764341022" data-image-width="106" data-orig-id="u39551-5" src="images/blank.gif?crc=4208392903"/><!-- rasterized frame -->
      <span class="grpelem placeholder" data-placeholder-for="u39552_content"><!-- placeholder node --></span>
     </div>
     <div class="clearfix colelem temp_no_id" data-orig-id="u23572"><!-- group -->
      <img class="grpelem temp_no_id temp_no_img_src" alt="Transaction History:" data-orig-src="images/u39595-45.png?crc=4086412143" data-image-width="110" data-orig-id="u39595-4" src="images/blank.gif?crc=4208392903"/><!-- rasterized frame -->
     </div>
    </div>
