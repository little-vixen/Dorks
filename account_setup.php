    ...
    <div class="clearfix colelem shared_content" id="u24358" data-content-guid="u24358_content"><!-- group -->
     <div class="grpelem" id="u24328"><!-- simple frame -->
		...
		<center><br></br><form method='post' action='account_setup.php'>
			...
			<br><br>
			<input style="font-size: 100%;background-color: #0000FF; color:antiquewhite; width: 375px; height: 40px" name="search" type="submit" value="Search">
			</form><br></br>
			...
			<tr>
				...
				<td class="cell-r">				
					<form action="account_setup.php" method="post">
						...
						<input style="font-size: 120%; background-color: #0000FF; color:antiquewhite; width: 280px; height:40px; " type='submit' name ="checking" value="Create Checking">
					</form>
				</td>
				<td class="cell-r">				
					<form action="account_setup.php" method="post">
						...
						<input type="hidden" name="fn" value="<?php echo $row['fn']; ?>">
						<input type="hidden" name="ln" value="<?php echo $row['ln']; ?>">
						<input style="font-size: 120%; background-color: #0000FF; color:antiquewhite; width: 280px; height:40px" type='submit' name ="saving" value="Create Savings">
					</form>
				</td>
			</tr>
		<?php } //endforeach loop ?>
