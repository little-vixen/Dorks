<?php
	...
	Loan Report Generator for Employee use.
	*/
	if (isset($_SESSION['aid'])) {
		if (isset($_POST['send'])) {
			$empty = array();
			$search = trim(filter_input(INPUT_POST, 'loan_search', FILTER_SANITIZE_STRING));
			
			try {
				require_once ('../pdo_config.php');
				/*
				Returns loan transactions for a customer.
				Input:	- ':cid' : Customer ID
				*/
				$sql = "SELECT * FROM ltransaction WHERE cid = :cid";
...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musemenu.js", "jquery.watch.js", "jquery.museresponsive.js", "require.js", "loans_report.css"], "outOfDate":[]};
</script>
  
  <title>loans_report</title>
  <!-- CSS -->
  <link rel="stylesheet" type="text/css" href="css/site_global.css?crc=444006867"/>
  <link rel="stylesheet" type="text/css" href="css/master_admin.css?crc=20483078"/>
  <link rel="stylesheet" type="text/css" href="css/loans_report.css?crc=108439951" id="pagesheet"/>
...
/* Hover cell effect! */
  ...
  <link rel="stylesheet" type="text/css" href="css/nomq_loans_report.css?crc=4025799575" id="nomq_pagesheet"/>
  <![endif]-->
  <!-- JS includes -->
  <!--[if lt IE 9]>
   ...
   <div class="clearfix borderbox" id="page"><!-- column -->
    ...
    <div class="clearfix colelem shared_content" id="u24358" data-content-guid="u24358_content"><!-- group -->
     <div class="grpelem" id="u24328"><!-- simple frame -->
		...
		<!--SEARCH-->
		<center><form method='post' action='loans_report.php'>
			<label style="font-size: 150%;  color: #0000FF;">Customer ID</label>
			<br><br>
			<input name="loan_search" type="text" style="width:375px; height:40px;">
			<br><br>
			<input style="font-size: 120%;background-color: #0000FF; color:antiquewhite; width: 375px; height: 40px; margin-bottom: 15px;" name="send" type="submit" value="Search">
		</form>
		</center>
		<!--LOAN TRANSACTIONS-->
