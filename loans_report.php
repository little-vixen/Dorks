...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musemenu.js", "jquery.watch.js", "require.js", "loans_report.css"], "outOfDate":[]};
</script>
  ...
  <link rel="stylesheet" type="text/css" href="css/loans_report.css?crc=165970972" id="pagesheet"/>
	 <style type="text/css">
  body,td,th {
    ...
    <div class="grpelem" id="u24328"><!-- simple frame -->
	   <!--SEARCH-->
		<center><form method='post' action='loans_report.php'>
			...
			<br><br>
			<input style="font-size: 100%;background-color: #0000FF; color: #fff; width: 375;margin-bottom:50;" name="send" type="submit" value="Search">
		</form>
		</center>
		<!--LOAN TRANSACTIONS-->
