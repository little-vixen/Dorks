	...
	if (isset($_SESSION['aid'])) {
		if (isset($_POST['send'])) {
			...
			try {
				...
				/*
				self join that Returns all customers from a single city
				Input:	- ':city' = customer addreses, city
				*/
				$sql = "SELECT DISTINCT a.cid, a.city, a.state FROM customerAddress a, customerAddress b WHERE a.city = b.city ORDER BY a.state, a.city";
...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musemenu.js", "jquery.watch.js", "jquery.museresponsive.js", "require.js", "demographics.css"], "outOfDate":[]};
</script>
  ...
  <link rel="stylesheet" type="text/css" href="css/demographics.css?crc=287448318" id="pagesheet"/>
...
/* Hover cell effect! */
  ...
  <link rel="stylesheet" type="text/css" href="css/nomq_demographics.css?crc=3862892197" id="nomq_pagesheet"/>
  <![endif]-->
  <!-- JS includes -->
  <!--[if lt IE 9]>
   ...
   <div class="clearfix borderbox" id="page"><!-- column -->
    ...
    <div class="clearfix colelem shared_content" id="u24358" data-content-guid="u24358_content"><!-- group -->
     <div class="grpelem" id="u24328"><!-- simple frame -->
		 ...
		 <!--SEARCH-->
		<center><form method='post' action='demographics.php'>
			<label style="font-size: 150%;  color: #0000FF;">City</label>
			<br><br>
			<input name="city_search" type="text" style="width:375px; height: 40px;">
			<br><br>
			<input style="font-size: 120%; background-color: #0000FF; color:antiquewhite; width: 375px; height: 40px; margin-bottom: 15px;" name="send" type="submit" value="Search"><br></br>
		</form>
		</center>
		<!--Demographics-->
		<table class="table" style="font-size: 100%; position:center;">
			<tr class="row-header">
				<td class="cell" colspan="4" style="text-align:left; margin-bottom: 15;">Dorks by City</td>
			</tr>
			<tr class="row-header">
				<td class="cell" colspan="1" style="text-align:left;">Dork ID</td>
