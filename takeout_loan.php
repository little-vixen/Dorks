<?php
	...
	Employees may help Customers take out loans.
	*/
...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musemenu.js", "jquery.watch.js", "jquery.museresponsive.js", "require.js", "takeout_loan.css"], "outOfDate":[]};
</script>
  
  <title>takeout_loan</title>
  <!-- CSS -->
  <link rel="stylesheet" type="text/css" href="css/site_global.css?crc=444006867"/>
  <link rel="stylesheet" type="text/css" href="css/master_admin.css?crc=20483078"/>
  <link rel="stylesheet" type="text/css" href="css/takeout_loan.css?crc=393191469" id="pagesheet"/>
	 <style type="text/css">
  body,td,th {
...
/* Hover cell effect! */
  ...
  <link rel="stylesheet" type="text/css" href="css/nomq_takeout_loan.css?crc=420692505" id="nomq_pagesheet"/>
  <![endif]-->
  <!-- JS includes -->
  <!--[if lt IE 9]>
   ...
   <div class="clearfix borderbox" id="page"><!-- column -->
    ...
    <div class="clearfix colelem shared_content" id="u24358" data-content-guid="u24358_content"><!-- group -->
     <div class="grpelem" id="u24328"><!-- simple frame -->
		...
		<!--SEARCH-->
		 <center>
		<form method='post' action='takeout_loan.php'>
			<label style="font-size: 150%;color: #0000FF;">First Name</label>
			<br><br>
			<input style="width:375px; height:40px;" name="checking_search" type="text">
			<br><br>
			<input style="font-size: 100%; background-color: #0000FF; color:antiquewhite; width: 375px; height: 40px; margin-bottom: 15px;" name="search" type="submit" value="Search">
			 </form></center>
		...
		<table class="table" style="position:center;">
			...
			<tr>
				<td class="cell-r">				
					<form action="takeout_loan_work.php" method="post">
						<input style="font-size: 120%; background-color: #0000FF; color:antiquewhite; width: 375px; height: 40px;" type='submit' name ="cid" value=<?php echo $row['cid'];?>>
					</form>
				</td>
