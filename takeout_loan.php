...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musemenu.js", "jquery.watch.js", "require.js", "takeout_loan.css"], "outOfDate":[]};
</script>
  ...
  <link rel="stylesheet" type="text/css" href="css/takeout_loan.css?crc=165970972" id="pagesheet"/>
	  <style type="text/css">
  body,td,th {
    ...
    <div class="grpelem" id="u24328"><!-- simple frame -->
	   <!--SEARCH-->
		<center><form method='post' action='takeout_loan.php'>
			...
			<br><br>
			<input style="font-size: 150%; background-color: #0000FF; color: #fff; width: 400;" name="search" type="submit" value="Search">
			</form></center><br></br>
